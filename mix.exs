defmodule NervesSystemLicheeNano.MixProject do
  use Mix.Project
  ...
  defp deps do
    [
      ...
      {:nerves_toolchain_armv5tejl_unknown_linux_musleabi, "~> 1.3.0", runtime: false},
  ...
  defp set_target() do
    if function_exported?(Mix, :target, 1) do
      ...
      System.put_env("MIX_TARGET", "lichee_nano")
    end
  end
end
